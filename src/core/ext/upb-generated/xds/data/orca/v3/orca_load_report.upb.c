...
static const upb_MiniTable_Field xds_data_orca_v3_OrcaLoadReport__fields[5] = {
  ...
  {2, UPB_SIZE(16, 24, 40), UPB_SIZE(0, 0, 0), kUpb_NoSub, 1, kUpb_FieldMode_Scalar | (kUpb_FieldRep_8Byte << kUpb_FieldRep_Shift)},
  {3, UPB_SIZE(24, 32, 48), UPB_SIZE(0, 0, 0), kUpb_NoSub, 4, kUpb_FieldMode_Scalar | (kUpb_FieldRep_8Byte << kUpb_FieldRep_Shift)},
...
const upb_MiniTable xds_data_orca_v3_OrcaLoadReport_msginit = {
  ...
  UPB_SIZE(32, 40, 56), 5, kUpb_ExtMode_NonExtendable, 5, 255, 0,
};

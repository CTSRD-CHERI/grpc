...
static const upb_MiniTable_Field envoy_admin_v3_SimpleMetric__fields[3] = {
  ...
  {2, UPB_SIZE(16, 24, 48), UPB_SIZE(0, 0, 0), kUpb_NoSub, 4, kUpb_FieldMode_Scalar | (kUpb_FieldRep_8Byte << kUpb_FieldRep_Shift)},
...
const upb_MiniTable envoy_admin_v3_SimpleMetric_msginit = {
  ...
  UPB_SIZE(24, 40, 56), 3, kUpb_ExtMode_NonExtendable, 3, 255, 0,
};

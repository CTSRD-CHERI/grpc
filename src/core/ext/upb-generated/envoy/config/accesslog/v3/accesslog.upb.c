...
static const upb_MiniTable_Field envoy_config_accesslog_v3_AccessLog__fields[3] = {
  ...
  {4, UPB_SIZE(20, 32, 64), UPB_SIZE(-5, -5, -5), 1, 11, kUpb_FieldMode_Scalar | (kUpb_FieldRep_Pointer << kUpb_FieldRep_Shift)},
};
...
const upb_MiniTable envoy_config_accesslog_v3_AccessLog_msginit = {
  ...
  UPB_SIZE(24, 40, 80), 3, kUpb_ExtMode_NonExtendable, 2, 255, 0,
};
...
static const upb_MiniTable_Field envoy_config_accesslog_v3_AccessLogFilter__fields[12] = {
  ...
  {12, UPB_SIZE(4, 8, 16), UPB_SIZE(-1, -1, -1), 11, 11, kUpb_FieldMode_Scalar | (kUpb_FieldRep_Pointer << kUpb_FieldRep_Shift)},
};
...
const upb_MiniTable envoy_config_accesslog_v3_AccessLogFilter_msginit = {
  ...
  UPB_SIZE(8, 16, 32), 12, kUpb_ExtMode_NonExtendable, 12, 255, 0,
};
...
const upb_MiniTable envoy_config_accesslog_v3_OrFilter_msginit = {
  ...
  UPB_SIZE(8, 8, 16), 1, kUpb_ExtMode_NonExtendable, 0, 255, 0,
};

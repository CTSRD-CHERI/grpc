...
static const upb_MiniTable_Field envoy_type_matcher_v3_ValueMatcher__fields[6] = {
  ...
  {5, UPB_SIZE(4, 8, 16), UPB_SIZE(-1, -1, -1), kUpb_NoSub, 8, kUpb_FieldMode_Scalar | (kUpb_FieldRep_1Byte << kUpb_FieldRep_Shift)},
...
const upb_MiniTable envoy_type_matcher_v3_ValueMatcher_msginit = {
  ...
  UPB_SIZE(8, 24, 32), 6, kUpb_ExtMode_NonExtendable, 6, 255, 0,
};

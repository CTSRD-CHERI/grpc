...
const upb_MiniTable_Extension envoy_annotations_disallowed_by_default_ext = {
  {189503207, UPB_SIZE(0, 0, 0), UPB_SIZE(0, 0, 0), kUpb_NoSub, 8, kUpb_FieldMode_Scalar | kUpb_LabelFlags_IsExtension | (kUpb_FieldRep_1Byte << kUpb_FieldRep_Shift)},
  &google_protobuf_FieldOptions_msginit,
  {.submsg = NULL},

};
const upb_MiniTable_Extension envoy_annotations_deprecated_at_minor_version_ext = {
  {157299826, UPB_SIZE(0, 0, 0), UPB_SIZE(0, 0, 0), kUpb_NoSub, 12, kUpb_FieldMode_Scalar | kUpb_LabelFlags_IsExtension | (kUpb_FieldRep_StringView << kUpb_FieldRep_Shift)},
  &google_protobuf_FieldOptions_msginit,
  {.submsg = NULL},

};
const upb_MiniTable_Extension envoy_annotations_disallowed_by_default_enum_ext = {
  {70100853, UPB_SIZE(0, 0, 0), UPB_SIZE(0, 0, 0), kUpb_NoSub, 8, kUpb_FieldMode_Scalar | kUpb_LabelFlags_IsExtension | (kUpb_FieldRep_1Byte << kUpb_FieldRep_Shift)},
  &google_protobuf_EnumValueOptions_msginit,
  {.submsg = NULL},

};
const upb_MiniTable_Extension envoy_annotations_deprecated_at_minor_version_enum_ext = {
  {181198657, UPB_SIZE(0, 0, 0), UPB_SIZE(0, 0, 0), kUpb_NoSub, 12, kUpb_FieldMode_Scalar | kUpb_LabelFlags_IsExtension | (kUpb_FieldRep_StringView << kUpb_FieldRep_Shift)},
  &google_protobuf_EnumValueOptions_msginit,
  {.submsg = NULL},

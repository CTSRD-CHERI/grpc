...
static const upb_MiniTable_Field envoy_config_core_v3_SubstitutionFormatString__fields[6] = {
  ...
  {4, UPB_SIZE(16, 24, 48), UPB_SIZE(0, 0, 0), kUpb_NoSub, 9, kUpb_FieldMode_Scalar | (kUpb_FieldRep_StringView << kUpb_FieldRep_Shift)},
  {5, UPB_SIZE(8, 8, 16), UPB_SIZE(-5, -5, -5), 1, 11, kUpb_FieldMode_Scalar | (kUpb_FieldRep_Pointer << kUpb_FieldRep_Shift)},

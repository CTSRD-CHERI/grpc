...
static const upb_MiniTable_Field envoy_config_trace_v3_ZipkinConfig__fields[7] = {
  ...
  {4, UPB_SIZE(28, 48, 80), UPB_SIZE(1, 1, 1), 0, 11, kUpb_FieldMode_Scalar | (kUpb_FieldRep_Pointer << kUpb_FieldRep_Shift)},
  {5, UPB_SIZE(4, 4, 4), UPB_SIZE(0, 0, 0), kUpb_NoSub, 5, kUpb_FieldMode_Scalar | (kUpb_FieldRep_4Byte << kUpb_FieldRep_Shift)},
  {6, UPB_SIZE(32, 56, 96), UPB_SIZE(0, 0, 0), kUpb_NoSub, 9, kUpb_FieldMode_Scalar | (kUpb_FieldRep_StringView << kUpb_FieldRep_Shift)},
...
const upb_MiniTable envoy_config_trace_v3_ZipkinConfig_msginit = {
  ...
  UPB_SIZE(40, 72, 128), 7, kUpb_ExtMode_NonExtendable, 7, 255, 0,
};

...
const upb_MiniTable envoy_config_core_v3_Extension_msginit = {
  ...
  UPB_SIZE(32, 72, 128), 5, kUpb_ExtMode_NonExtendable, 5, 255, 0,
};
...
static const upb_MiniTable_Field envoy_config_core_v3_HeaderValueOption__fields[3] = {
  ...
  {2, UPB_SIZE(12, 16, 32), UPB_SIZE(2, 2, 2), 1, 11, kUpb_FieldMode_Scalar | (kUpb_FieldRep_Pointer << kUpb_FieldRep_Shift)},
...
const upb_MiniTable envoy_config_core_v3_DataSource_msginit = {
  ...
  UPB_SIZE(12, 24, 48), 4, kUpb_ExtMode_NonExtendable, 4, 255, 0,
};

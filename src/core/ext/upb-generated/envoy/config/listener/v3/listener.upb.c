...
static const upb_MiniTable_Field envoy_config_listener_v3_Listener__fields[29] = {
  ...
  {27, UPB_SIZE(120, 216, 416), UPB_SIZE(-17, -17, -17), 19, 11, kUpb_FieldMode_Scalar | (kUpb_FieldRep_Pointer << kUpb_FieldRep_Shift)},
...
const upb_MiniTable envoy_config_listener_v3_Listener_msginit = {
  ...
  UPB_SIZE(124, 232, 432), 29, kUpb_ExtMode_NonExtendable, 13, 255, 0,
};
